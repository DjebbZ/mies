...
(defn mies [name]
  (let [data {:name name
    ...
    (->files data
      ...
      ["scripts/nashorn-repl" (render "nashorn-repl" data) :executable true]
      ["scripts/nashorn-repl.bat" (render "nashorn-repl.bat" data)]
      ["scripts/nashorn_repl.clj" (render "nashorn_repl.clj" data)]
